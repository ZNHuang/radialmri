...
parser.add_argument('-f', '--frames', help='frames/time points', default=22)
...
inp_spokes = int(args.spokes) # each time point has 21 spokes
nt = int(args.frames) #number of time points
...
datadir = '/gpfs/home/zh1115/knolllabspace/hzn/storage/newsimulation/simulated_20200726/sim_{}.mat'.format(caseidx) #simulated images
#caseidx = 'BC18'
...
#--------------save---------------
savemat('{}/{}_sim21spokes_origsmap_{}_{:.2e}.mat'.format(savedir, caseidx, csidx, nl), mdict ={
...
if niter > 0:
    ...
    for lbd in lambdalist:
        for tl in tolerancelist:
            gifname = '{}/sim_21spokes_loadedsmap_case{}_cs{}_Recon_iGRASP_lambda{}_tolerance{}_iterations{}_noise{:.2e}.gif'.format(savedir, caseidx, csidx
                    , lbd, tl, niter, nl)
